class HomeTwitter extends Scene {
  constructor() {
    super()
    this.reset()
  }
  ...
  reset() {
          ...
          if (layout[s][r][c] !== 0) {
            this.shapes.push(new Poly(
              ...
              [
                ...
                { delay: 2000, duration: 250, props: { x: 28 + (w * c) + (Game.width * s) }},
    ...
    this.transition = new Poly(
      ...
      [
        ...
        { delay: 10000, duration: 2000, props: { alpha: 255 }},
        this.endBuffer()
      ]
    )

    this.transition_out = new Poly(
      { x: 0, y: 0, w: 0, h: 0, color: '#1d9bf0' },
      [
        this.startBuffer(),
        { delay: 12000, duration: 0, props: { x: 172, y: 102, w: 48, h: 48 }},
